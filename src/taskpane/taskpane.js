...
function displayStartingMessage(starter) {
  chatWindow.innerHTML += `<div class="bot-wrapper"><img width=20 height=20 src="copilot.png"/> Legal Agent</div><div class="message bot">${starter}</div>`;
}
  ...
  if (response && response.attachments && response.attachments.length > 0  ) {
      ...
      if (attachment.content && attachment.content.buttons && attachment.content.buttons.length > 0) {
        attachment.content.buttons.forEach((button) => {
          if (button.type === "signin") {
            ...
            chatWindow.innerHTML += `<div class="bot-wrapper"><img width=20 height=20 src="copilot.png"/> Legal Agent</div><div class="message bot">${attachment.content.text}</div>`;
    ...
    if (role === "bot") {
      if(response.speak==="Generate"){
        ...
        chatWindow.innerHTML += `<div class="bot-wrapper"><img width=20 height=20 src="copilot.png"/> Legal Agent</div><div class="message bot">SOW content generated in document</div>`;
        if(speechFlag){
          ensureVoicesLoaded(() => {
        ...
        chatWindow.innerHTML += `<div class="bot-wrapper"><img width=20 height=20 src="copilot.png"/> Legal Agent</div><div class="message bot">Table has been generated in document</div>`;      
        if(speechFlag){
          ensureVoicesLoaded(() => {
        ...
        //speechFlag = false;  
          ...
          chatWindow.innerHTML += `<div class="bot-wrapper"><img width=20 height=20 src="copilot.png"/> Legal Agent</div><div class="message bot">No table is selected in the document</div>`;      
        if(speechFlag){
          ensureVoicesLoaded(() => {
        ...
        chatWindow.innerHTML += `<div class="bot-wrapper"><img width=20 height=20 src="copilot.png"/> Legal Agent</div><div class="message bot">Replaced ${textArray[0]} with ${textArray[1]} </div>`;      
        if(speechFlag){
          ensureVoicesLoaded(() => {
        ...
        chatWindow.innerHTML += `<div class="bot-wrapper"><img width=20 height=20 src="copilot.png"/> Legal Agent</div><div class="message bot">Requested changes have been made in the document</div>`;  
        if(speechFlag){
          ensureVoicesLoaded(() => {
        ...
        chatWindow.innerHTML += `<div class="bot-wrapper"><img width=20 height=20 src="copilot.png"/> Legal Agent</div><div class="message bot">${response.text}</div>`;
...
function displayLoading(){
  if(loader){
    ...
    let loadingDots = [ ".", "..", "..."];
    let dotIndex = 1;
    loadingElement.innerHTML += `<div id="loader-container" class="bot-wrapper"><img width=20 height=20 src="copilot.png"/> Legal Agent</div><div id = "loader" class="message bot">.</div>`;
